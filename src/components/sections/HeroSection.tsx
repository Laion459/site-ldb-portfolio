    ...
    >
      ...
      {showParticles && (
        <div className='absolute inset-0 pointer-events-none'>
          <ParticleSystem
            key='particle-system' // ✅ Key única para evitar re-mount
            particleCount={80}
      ...
      <div className='absolute inset-0 overflow-hidden'>
        ...
        {showMorphing && (
          <div className='absolute inset-0 pointer-events-none'>
            <MorphingShapes
              key='morphing-shapes' // ✅ Key única para evitar re-mount
              shapeCount={4}
        ...
        >
          ...
          >
            ...
            <motion.span
              ...
              className='inline-block'
            >
              Transformo ideias em produtos completos e escaláveis que geram
              valor real.
            </motion.span>
          </motion.p>
        </motion.div>
