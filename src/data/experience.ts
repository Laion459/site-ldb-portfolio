...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      'Otimizei performance de aplicações web com melhorias de 60-80% no tempo de carregamento',
      'Desenvolvi APIs REST robustas para integração com sistemas externos',
    ],
  },
  {
    id: '3',
